...
-(const char*) iconv_ext:(iconv_t) cd data:(char*) data{
//#ifdef __FreeBSD
	const char* src;
//#else
//	char * src;
//#endif
	...
	if(iconv(cd, &src, &inlen, &tmp, &outlen) == (size_t)(-1))
		return NULL;
...
//	zipInfo.dosDate = (unsigned long) current;
    ...
    const char* filename = [self iconv_ext:cd data:[newname UTF8String]];
    iconv_close(cd);
	if( [_password length] == 0 ){
        
		ret = zipOpenNewFileInZip( _zipFile,
                                  filename,
//                                  (const char*) [newname cStringUsingEncoding:NSASCIIStringEncoding],
//								  (const char*) [newname UTF8String],
//                                  (const char*) [newname cStringUsingEncoding:NSUnicodeStringEncoding],
								  &zipInfo,
								  NULL,0,
								  NULL,0,
								  NULL,//comment
